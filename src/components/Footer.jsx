    ...
    <>
      <header className="bg-[#F7F8F8] text-center p-28">
        ...
        <div className="flex justify-center gap-4">
          <p className="border-r-2 border-[#E4EBED] py-4 pr-4 flex">
            <HiOutlineShoppingBag className="text-4xl mr-3" /> Más de 75 tiendas
            físicas en España
          </p>
          <p className="border-r-2 border-[#E4EBED] py-4  pr-4 flex">
      ...
      {/*   formas de pago */}
      <div className="text-center flex justify-center font-bold gap-20 m-10">
        ...
        <div className="flex flex-col items-start">
          ...
          <img src="./img/Icon_SEUR.webp" alt="" />
        </div>
      ...
      <footer className="grid grid-cols-4 bg-[#F7F8F8] text-center gap-10 p-10">
        {/* Atención al cliente */}
